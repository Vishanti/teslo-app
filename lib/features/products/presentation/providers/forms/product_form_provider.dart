...
import 'package:teslo_app/features/products/presentation/providers/provider.dart';
...
final productFormProvider = StateNotifierProvider.autoDispose
  ...
  final createOrUpdateCallback =
      ref.watch(productsProvider.notifier).createOrUpdateProduct;

  return ProductFormNotifier(
      product: product, onSubmitCallback: createOrUpdateCallback);
});
